...
2. Current KBB Fair Purchase Price or Edmunds Suggested Price validation
...
- Market pricing (Edmunds Suggested Price, KBB FPP): within 60 days acceptable; within 30 days preferred
...
## Pricing Analysis
If you can find specific information on the year/make/model/trim provided via web search use that, otherwise use the below.
...
- Edmunds Suggested Price (search live)
...
- Comparison to Edmunds Suggested Price / KBB Fair Purchase Price
...
### 3. Lease Program Analysis *(lease deals only — omit section for purchase)*
...
### 4. Financing Analysis *(purchase deals only — omit section for lease)*
...
### 6. Payment and Structure Analysis
